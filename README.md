...
# About
Slight modification of [@AlanTheBenign's stronghold finder](https://github.com/AlantheBenign/stronghold-finder) to read directly from the clipboard, which also reads nether coords. With a minimalist design approach, ease of use was a main priority targetted for speedrunning. Any questions or concerns about the algorithm of the stronghold finder should be directed toward https://github.com/AlantheBenign/Minecraft-Stronghold-Finder.
